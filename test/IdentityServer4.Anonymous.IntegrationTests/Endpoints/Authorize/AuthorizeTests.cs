...
namespace IdentityServer4.Anonymous.IntegrationTests.Endpoints.Authorize
{
    public class AuthorizeTests
    {
        ...
        #region IdentityServer4 native tests
        ...
        [Theory]
        [TestCase(null)]
        [TestCase("IdentityServer4.Stores.QueryStringAuthorizationParametersMessageStore, IdentityServer4")]
        [TestCase("IdentityServer4.Stores.Default.DistributedCacheAuthorizationParametersMessageStore, IdentityServer4")]
        public async Task signin_request_should_have_authorization_params(string storeTypeName)
        {
            if (storeTypeName != null)
            {
                var storeType = Type.GetType(storeTypeName);
        ...
        [TestCase("IdentityServer4.Stores.QueryStringAuthorizationParametersMessageStore, IdentityServer4")]
        [TestCase("IdentityServer4.Stores.Default.DistributedCacheAuthorizationParametersMessageStore, IdentityServer4")]
        public async Task login_response_and_consent_response_should_receive_authorization_response(string storeTypeName)
        {
            if (storeTypeName != null)
            {
                var storeType = Type.GetType(storeTypeName);
        ...
        [TestCase(null, null)]
        [TestCase("0", "json")]
        public async Task for_invalid_client_error_page_should_not_receive_client_id(string acrValues, string responseMode)
        {
            await _mockPipeline.LoginAsync("bob");
        ...
        [TestCase(null, null)]
        [TestCase("0", "json")]
        public async Task error_page_should_receive_client_id(string acrValues, string responseMode)
        {
            await _mockPipeline.LoginAsync("bob");
        ...
        [TestCase(null, null)]
        [TestCase("0", "json")]
        public async Task invalid_redirect_uri_should_show_error_page(string acrValues, string responseMode)
        {
            await _mockPipeline.LoginAsync("bob");
            ...
            _mockPipeline.ErrorWasCalled.Should().BeTrue();
            _mockPipeline.ErrorMessage.Error.Should().Be(IdentityModel.OidcConstants.AuthorizeErrors.UnauthorizedClient);
        ...
        [TestCase(null, null)]
        [TestCase("0", "json")]
        public async Task invalid_redirect_uri_should_not_pass_return_url_to_error_page(string acrValues, string responseMode)
        {
            await _mockPipeline.LoginAsync("bob");
        ...
        [TestCase(null, null)]
        [TestCase("0", "json")]
        public async Task invalid_client_id_should_show_error_page(string acrValues, string responseMode)
        {
            await _mockPipeline.LoginAsync("bob");
        ...
        [TestCase(null, null)]
        [TestCase("0", "json")]
        public async Task invalid_client_id_should_not_pass_return_url_to_error_page(string acrValues, string responseMode)
        {
            await _mockPipeline.LoginAsync("bob");
        ...
        [TestCase(null, null)]
        [TestCase("0", "json")]
        public async Task missing_redirect_uri_should_show_error_page(string acrValues, string responseMode)
        {
            await _mockPipeline.LoginAsync("bob");
        ...
        [TestCase(null, null)]
        [TestCase("0", "json")]
        public async Task missing_redirect_uri_should_not_pass_return_url_to_error_page(string acrValues, string responseMode)
        {
            await _mockPipeline.LoginAsync("bob");
        ...
        [TestCase(null, null)]
        [TestCase("0", "json")]
        public async Task malformed_redirect_uri_should_show_error_page(string acrValues, string responseMode)
        {
            await _mockPipeline.LoginAsync("bob");
        ...
        [TestCase(null, null)]
        [TestCase("0", "json")]
        public async Task disabled_client_should_show_error_page(string acrValues, string responseMode)
        {
            await _mockPipeline.LoginAsync("bob");
        ...
        [TestCase(null, null)]
        [TestCase("0", "json")]
        public async Task disabled_client_should_not_pass_return_url_to_error_page(string acrValues, string responseMode)
        {
            await _mockPipeline.LoginAsync("bob");
        ...
        [TestCase(null, null)]
        [TestCase("0", "json")]
        public async Task invalid_protocol_for_client_should_show_error_page(string acrValues, string responseMode)
        {
            await _mockPipeline.LoginAsync("bob");
        ...
        [TestCase(null, null)]
        [TestCase("0", "json")]
        public async Task invalid_protocol_for_client_should_not_pass_return_url_to_error_page(string acrValues, string responseMode)
        {
            await _mockPipeline.LoginAsync("bob");
        ...
        [TestCase(null, null)]
        [TestCase("0", "json")]
        public async Task invalid_response_type_should_show_error_page(string acrValues, string responseMode)
        {
            await _mockPipeline.LoginAsync("bob");
            ...
            _mockPipeline.ErrorWasCalled.Should().BeTrue();
            _mockPipeline.ErrorMessage.Error.Should().Be(IdentityModel.OidcConstants.AuthorizeErrors.UnsupportedResponseType);
        }

        [Test]
        [TestCase(null, null)]
        [TestCase("0", "json")]
        public async Task invalid_response_type_should_not_pass_return_url_to_error_page(string acrValues, string responseMode)
        {
            await _mockPipeline.LoginAsync("bob");
        ...
        [TestCase(null)]
        [TestCase("0")]
        public async Task invalid_response_mode_for_flow_should_show_error_page(string acrValues)
        {
            await _mockPipeline.LoginAsync("bob");
        ...
        [TestCase(null)]
        [TestCase("0")]
        public async Task invalid_response_mode_for_flow_should_pass_return_url_to_error_page(string acrValues)
        {
            await _mockPipeline.LoginAsync("bob");
        ...
        [TestCase(null)]
        [TestCase("0")]
        public async Task invalid_response_mode_should_show_error_page(string acrValues)
        {
            await _mockPipeline.LoginAsync("bob");
        ...
        [TestCase(null)]
        [TestCase("0")]
        public async Task invalid_response_mode_should_pass_return_url_to_error_page(string acrValues)
        {
            await _mockPipeline.LoginAsync("bob");
        ...
        [TestCase(null, null)]
        [TestCase("0", "json")]
        public async Task missing_scope_should_show_error_page(string acrValues, string responseMode)
        {
            await _mockPipeline.LoginAsync("bob");
            ...
            _mockPipeline.ErrorWasCalled.Should().BeTrue();
            _mockPipeline.ErrorMessage.Error.Should().Be(IdentityModel.OidcConstants.AuthorizeErrors.InvalidRequest);
        ...
        [TestCase(null, null)]
        [TestCase("0", "json")]
        public async Task missing_scope_should_pass_return_url_to_error_page(string acrValues, string responseMode)
        {
            await _mockPipeline.LoginAsync("bob");
        ...
        [TestCase(null)]
        [TestCase("0")]
        public async Task explicit_response_mode_should_be_passed_to_error_page(string acrValues)
        {
            await _mockPipeline.LoginAsync("bob");
        ...
        [TestCase(null, null)]
        [TestCase("0", "json")]
        public async Task scope_too_long_should_show_error_page(string acrValues, string responseMode)
        {
            await _mockPipeline.LoginAsync("bob");
        ...
        [TestCase(null, null)]
        [TestCase("0", "json")]
        public async Task missing_openid_scope_should_show_error_page(string acrValues, string responseMode)
        {
            await _mockPipeline.LoginAsync("bob");
        ...
        [TestCase(null, null)]
        [TestCase("0", "json")]
        public async Task client_not_allowed_access_to_scope_should_show_error_page(string acrValues, string responseMode)
        {
            await _mockPipeline.LoginAsync("bob");
        ...
        [TestCase(null, null)]
        [TestCase("0", "json")]
        public async Task missing_nonce_should_show_error_page(string acrValues, string responseMode)
        {
            await _mockPipeline.LoginAsync("bob");
        ...
        [TestCase(null, null)]
        [TestCase("0", "json")]
        public async Task nonce_too_long_should_show_error_page(string acrValues, string responseMode)
        {
            await _mockPipeline.LoginAsync("bob");
        ...
        [TestCase(null, null)]
        [TestCase("0", "json")]
        public async Task locale_too_long_should_show_error_page(string acrValues, string responseMode)
        {
            await _mockPipeline.LoginAsync("bob");
        ...
        [TestCase(null, null)]
        [TestCase("0", "json")]
        public async Task invalid_max_age_should_show_error_page(string acrValues, string responseMode)
        {
            await _mockPipeline.LoginAsync("bob");
        ...
        [TestCase(null, null)]
        [TestCase("0", "json")]
        public async Task negative_max_age_should_show_error_page(string acrValues, string responseMode)
        {
            await _mockPipeline.LoginAsync("bob");
        ...
        [TestCase(null, null)]
        [TestCase("0", "json")]
        public async Task login_hint_too_long_should_show_error_page(string acrValues, string responseMode)
        {
            await _mockPipeline.LoginAsync("bob");
        ...
        [TestCase(null, null)]
        [TestCase("0", "json")]
        public async Task overlapping_identity_scopes_and_api_scopes_should_show_error_page(string acrValues, string responseMode)
        {
        ...
        public async Task Anonymous_user_with_valid_request_and_implicit_flow_should_receive_authorization_response()
        {
            ...
            ((string)result["id_token"]).Should().NotBeNull();
            ((string)result["state"]).Should().Be("123_state");
            ((string)result["scope"]).Should().Be("openid");
            _mockPipeline.LoginWasCalled.Should().Be(false);
        }

        [Test]
        public async Task Anonymous_user_with_valid_request_and_implicit_flow_should_receive_authorization_response_without_consent_confirmation()
        {
            var url = _mockPipeline.CreateAuthorizeUrl(
                clientId: "client2",
                responseType: "id_token token",
        ...
        [Test]
        public async Task Anonymous_user_with_valid_request_and_code_flow_should_receive_authorization_response()
        {
            var url = _mockPipeline.CreateAuthorizeUrl(
                clientId: "client4",
                responseType: "code",
            ...
            var result = JObject.Parse(await response.Content.ReadAsStringAsync());
            ((string)result["code"]).Should().NotBeNull();
            ((string)result["state"]).Should().Be("123_state");
            ((string)result["scope"]).Should().Be("openid");
            _mockPipeline.LoginWasCalled.Should().Be(false);
        }
        ...
        [Test]
        public async Task Authenticated_user_with_valid_anonymous_request_should_receive_authorization_response_as_json()
        {
            await _mockPipeline.LoginAsync("bob");

            _mockPipeline.LoginWasCalled.Should().Be(true);
